...
DEFAULT_STATE = {
    "site": {
        "name": "The Royal Kingdom of Melonia",
        "motto": "FOR THE KING",
        ...
        "territories": [
            {
                ...
                "name": "Melonia Main",
                "summary": {
                    "en": "The principal seat of the Kingdom and the ceremonial center of national administration.",
                    "nl": "De hoofdzetel van het Koninkrijk en het ceremoniële centrum van het nationale bestuur.",
                    "no": "Kongedømmets hovedsete og det seremonielle sentrum for den nasjonale administrasjonen.",
                    "it": "La sede principale del Regno e il centro cerimoniale dell'amministrazione nazionale.",
                },
            },
            {
                "key": "meloniaSouth",
                "name": "Melonia South",
                "summary": {
                    "en": "A southern territorial division represented within the wider kingdom structure.",
                    "nl": "Een zuidelijke territoriale afdeling die vertegenwoordigd is binnen de bredere koninkrijksstructuur.",
                    "no": "En sørlig territoriell inndeling representert i den bredere kongedømmestrukturen.",
                    "it": "Una divisione territoriale meridionale rappresentata all'interno della più ampia struttura del regno.",
                },
            },
            {
                "key": "meloniaNorth",
